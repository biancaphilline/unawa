  ...
  <body>
    <div class="submit-sign-page">
      <div class="navbar">
        ...
        <img class="user-profile" src="assets\assets-svg\user-profile.svg" />
      </div>
      <div class="flex-row">
        <div class="title">
          <div class="flex-container-151 flex-container">
            <div class="text">
              <span class="span0">Elevate</span>
              <span class="span2">Sign</span>
              <span class="span3">Language:</span>
            </div>
            <div class="text">
              <span class="span">Your Signs,</span>
            </div>
            <div class="text">
              <span class="span">Our Progress</span>
            </div>
          </div>
          <p class="join-us-in-enriching">
            Join us in enriching unawa's sign language database. Share your
            sings and help us build a more inclusive communication platform for
            all.
          </p>
        </div>
        ...
        <!-- Submission Form -->
          ...
          <form class="submit-form" method="post" action="process_submission.php">
